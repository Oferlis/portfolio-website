...
export default function Projects() {                
    ...
    return (<div id="projects" className="div-ex projects-div">
            ...
            <ul className="">
                <li className={`proj-list-item ${isSelected ? 'selected' : ''}`} onClick={() => handleItemClicked(readingList)}>Reading List</li>
                <li className="proj-list-item" onClick={() => handleItemClicked(overlay)}>Overlay</li>
                <li className="proj-list-item" onClick={() => handleItemClicked(sharkio)}>Sharkio</li>
                <li className="proj-list-item" onClick={() => handleItemClicked(portfolioSite)}>Portfolio site</li>
