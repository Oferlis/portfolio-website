export default function About() {
    return (<div id="about" className="flex flex-row md:mx-20 mx-4 px-6 py-12 shadow-xl bg-[#c9e4eb] space-around rounded-lg md:h-96 items-start mt-4 font-montserrat">
            ...
            I am a passionate software developer, currently working at Kyndryl.<br/>

            I believe in continuous learning and staying up-to-date with the latest industry trends,
            collaboration and effective communication are fundamental to my work.<br/><br/>

            In my spare time I contribute to opensource projects and practice towards running half marathon 🏃 <br/><br/>
